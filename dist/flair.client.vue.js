...
(function(root, factory) {
    ...
    let settings = JSON.parse('{"vue":{"extensions":[]}}');
    ...
    await (async () => { // type: ./src/flair.client.vue/flair.ui/@1-VueComponentMembers.js
        ...
        Mixin('VueComponentMembers', function() {
            ...
            this.define = async () => {
                ...
                const { ViewHandler, ViewState } = await ns('flair.ui', './flair.client.js');
